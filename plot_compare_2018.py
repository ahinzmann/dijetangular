...
if __name__=="__main__":
    ...
    f3=TFile.Open("/nfs/dust/cms/user/hinzmann/dijetangular/uhh2.AnalysisModuleRunner.DATA.Run2018_RunABCD_RunII_102X_v1.root")
    ...
    for i in range(len(massbins)):
      ...
      h3=f3.Get("Dijet/chi_"+str(massbins[i][0])+"_"+str(massbins[i][1]))
